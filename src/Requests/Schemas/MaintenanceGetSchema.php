...
final class MaintenanceGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for maintenance.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/maintenance/maintenance.get',
            'title' => 'maintenance.get',
            'description' => 'Retrieve maintenances according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/maintenance/get',
            'type' => 'object',
            'properties' => [
                'groupids' => [
                    'oneOf' => [
                ...
                'selectHostGroups' => [
                    ...
                    'description' => 'Return a hostgroups property with host groups assigned to the maintenance.',
                ],
                'selectHosts' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a hosts property with hosts assigned to the maintenance.',
                ],
                'selectTags' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a tags property with problem tags of the maintenance.',
                ],
                'selectTimeperiods' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a timeperiods property with time periods of the maintenance.',
                ],
                'selectGroups' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Deprecated. Please use selectHostGroups instead. Return a groups property with host groups assigned to the maintenance.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: maintenanceid, name, maintenance_type, active_since, active_till.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
