...
final class IconmapUpdateSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for iconmap.update, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/iconmap/iconmap.update',
            'title' => 'iconmap.update',
            'description' => 'Update existing icon maps.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/iconmap/update',
            'type' => 'object',
            'properties' => [
                'iconmapid' => [
                    'type' => 'string',
                    'description' => 'ID of the icon map. Property behavior: read-only, required for update operations.',
                ],
                'name' => [
                    'type' => 'string',
                ...
                'mappings' => [
                    ...
                    'description' => 'Icon mappings to replace the existing icon mappings.',
                ],
            ],
            'required' => [
                'iconmapid',
