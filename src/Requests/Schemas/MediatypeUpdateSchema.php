...
final class MediatypeUpdateSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for mediatype.update, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/mediatype/mediatype.update',
            'title' => 'mediatype.update',
            'description' => 'Update existing media types.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/mediatype/update',
            'type' => 'object',
            'properties' => [
                'mediatypeid' => [
                    'type' => 'string',
...
- required',
                ...
                'message_templates' => [
                    'type' => 'array',
                    'description' => 'Message templates to replace the current message templates.',
                    'items' => [
                        'type' => 'object',
                        'properties' => [
                            'eventsource' => [
