...
final class TriggerCreateSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for trigger.create, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/trigger/trigger.create',
            'title' => 'trigger.create',
            'description' => 'Create new triggers.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/trigger/create',
            'type' => 'object',
            'properties' => [
                'description' => [
                    'type' => 'string',
