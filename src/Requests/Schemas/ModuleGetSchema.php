...
final class ModuleGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for module.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/module/module.get',
            'title' => 'module.get',
            'description' => 'Retrieve modules according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/module/get',
            'type' => 'object',
            'properties' => [
                'moduleids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only modules with the given IDs.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: moduleid, relative_path.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
