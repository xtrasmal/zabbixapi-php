...
final class ImageGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for image.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/image/image.get',
            'title' => 'image.get',
            'description' => 'Retrieve images according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/image/get',
            'type' => 'object',
            'properties' => [
                'imageids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only images with the given IDs.',
                ],
                'sysmapids' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return images that are used on the given maps.',
                ],
                'select_image' => [
                    'type' => 'boolean',
                    'description' => 'Return an image property with the Base64 encoded image.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: imageid, name.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
