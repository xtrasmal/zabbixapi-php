...
final class ReportGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for report.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/report/report.get',
            'title' => 'report.get',
            'description' => 'Retrieve scheduled reports according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/report/get',
            'type' => 'object',
            'properties' => [
                'reportids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only scheduled reports with the given report IDs.',
                ],
                'expired' => [
                    'type' => 'boolean',
                    'description' => 'If set to true return only expired scheduled reports.',
                ],
                'selectUsers' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a users property with users the report is configured to be sent to.',
                ],
                'selectUserGroups' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a user_groups property with user groups the report is configured to be sent to.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: reportid, name, status.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
