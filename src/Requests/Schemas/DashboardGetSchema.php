...
final class DashboardGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for dashboard.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/dashboard/dashboard.get',
            'title' => 'dashboard.get',
            'description' => 'Retrieve dashboards according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/dashboard/get',
            'type' => 'object',
            'properties' => [
                'dashboardids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only dashboards with the given IDs.',
                ],
                'selectPages' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a pages property with dashboard pages, correctly ordered.',
                ],
                'selectUsers' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a users property with users that the dashboard is shared with.',
                ],
                'selectUserGroups' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a userGroups property with user groups that the dashboard is shared with.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: dashboardid.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
