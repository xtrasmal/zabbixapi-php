...
final class ValuemapGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for valuemap.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/valuemap/valuemap.get',
            'title' => 'valuemap.get',
            'description' => 'Retrieve value maps according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/valuemap/get',
            'type' => 'object',
            'properties' => [
                'valuemapids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only value maps with the given IDs.',
                ],
                'selectMappings' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return the value mappings for current value map in the mappings property. See the Value mappings object (reference/valuemap/object#value-mappings). Supports count.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: valuemapid, name.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
