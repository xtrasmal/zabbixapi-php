...
final class TemplateDashboardApi extends AbstractApi
{
    ...
    public function create(TemplatedashboardCreateRequest|array $request): ZabbixRequest
    {
        return $this->request(TemplatedashboardCreateRequest::class, $request);
    }

    /** @param list<mixed> $request */
    public function delete(TemplatedashboardDeleteRequest|array $request): ZabbixRequest
    {
        return $this->request(TemplatedashboardDeleteRequest::class, $request);
    }

    /** @param array<string, mixed> $request */
    public function get(TemplatedashboardGetRequest|array $request = []): ZabbixRequest
    {
    ...
    /** @param array<string, mixed> $request */
    public function update(TemplatedashboardUpdateRequest|array $request): ZabbixRequest
    {
