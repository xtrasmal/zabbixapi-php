...
final class ConnectorGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for connector.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/connector/connector.get',
            'title' => 'connector.get',
            'description' => 'Retrieve connectors according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/connector/get',
            'type' => 'object',
            'properties' => [
                'connectorids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only connectors with the given IDs.',
                ],
                'selectTags' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a tags property with connector tag filter. Supports count.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: connectorid, name, data_type, status.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
