...
final class ProxyGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for proxy.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/proxy/proxy.get',
            'title' => 'proxy.get',
            'description' => 'Retrieve proxies according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/proxy/get',
            'type' => 'object',
            'properties' => [
                'proxyids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only proxies with the given IDs.',
                ],
                'proxy_groupids' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return only proxies that belong to the given proxy groups.',
                ],
                'selectAssignedHosts' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return an assignedHosts property with the hosts assigned to the proxy. Supports count.',
                ],
                'selectHosts' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a hosts property with the hosts monitored by the proxy. Supports count.',
                ],
                'selectProxyGroup' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a proxyGroup property with the proxy group object.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: proxyid, name, operating_mode.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
