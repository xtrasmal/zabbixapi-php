...
final class GraphApi extends AbstractApi
{
    ...
    public function create(GraphCreateRequest|array $request): ZabbixRequest
    {
        return $this->request(GraphCreateRequest::class, $request);
    }

    /** @param list<mixed> $request */
    public function delete(GraphDeleteRequest|array $request): ZabbixRequest
    {
        return $this->request(GraphDeleteRequest::class, $request);
    }

    /** @param array<string, mixed> $request */
    public function get(GraphGetRequest|array $request = []): ZabbixRequest
    {
    ...
    /** @param array<string, mixed> $request */
    public function update(GraphUpdateRequest|array $request): ZabbixRequest
    {
