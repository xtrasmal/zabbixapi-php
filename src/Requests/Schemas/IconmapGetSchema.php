...
final class IconmapGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for iconmap.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/iconmap/iconmap.get',
            'title' => 'iconmap.get',
            'description' => 'Retrieve icon maps according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/iconmap/get',
            'type' => 'object',
            'properties' => [
                'iconmapids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only icon maps with the given IDs.',
                ],
                'sysmapids' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return only icon maps that are used in the given maps.',
                ],
                'selectMappings' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a mappings property with the icon mappings used.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: iconmapid, name.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
