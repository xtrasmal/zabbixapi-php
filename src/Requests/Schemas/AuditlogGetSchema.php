...
final class AuditlogGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for auditlog.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/auditlog/auditlog.get',
            'title' => 'auditlog.get',
            'description' => 'Retrieve audit log records according to the given parameters. Restricted to Super admin user types (permissions manageable via user role settings).',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/auditlog/get',
            'type' => 'object',
            'properties' => [
                'auditids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only audit log with the given IDs.',
                ],
                'userids' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return only audit log that were created by the given users.',
                ],
                'time_from' => [
                    'type' => 'integer',
                    'description' => 'Returns only audit log entries that have been created after or at the given time.',
                ],
                'time_till' => [
                    'type' => 'integer',
                    'description' => 'Returns only audit log entries that have been created before or at the given time.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
                ...
                'sortfield' => [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: auditid, userid, clock.',
                ],
                'sortorder' => [
                    'oneOf' => [
                        [
