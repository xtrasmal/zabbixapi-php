...
final class CorrelationGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for correlation.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/correlation/correlation.get',
            'title' => 'correlation.get',
            'description' => 'Retrieve correlations according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/correlation/get',
            'type' => 'object',
            'properties' => [
                'correlationids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only correlations with the given IDs.',
                ],
                'selectFilter' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a filter property with the correlation conditions.',
                ],
                'selectOperations' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return an operations property with the correlation operations.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: correlationid, name, status.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
