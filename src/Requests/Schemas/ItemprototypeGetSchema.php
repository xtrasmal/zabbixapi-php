...
final class ItemprototypeGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for itemprototype.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/itemprototype/itemprototype.get',
            'title' => 'itemprototype.get',
            'description' => 'Retrieve item prototypes according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/itemprototype/get',
            'type' => 'object',
            'properties' => [
                'discoveryids' => [
                    'oneOf' => [
                ...
                'inherited' => [
                    'type' => 'boolean',
                    'description' => 'If set to true return only item prototypes inherited from a template.',
                ],
                'itemids' => [
                    'oneOf' => [
                        [
                ...
                'monitored' => [
                    'type' => 'boolean',
                    'description' => 'If set to true return only enabled item prototypes that belong to monitored hosts.',
                ],
                'templated' => [
                    'type' => 'boolean',
                    'description' => 'If set to true return only item prototypes that belong to templates.',
                ],
                'templateids' => [
                    'oneOf' => [
                        [
                ...
                'selectDiscoveryRule' => [
                    ...
                    'description' => 'Return a discoveryRule property with the low-level discovery rule that the item prototype belongs to.',
                ],
                'selectGraphs' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a graphs property with graph prototypes that the item prototype is used in. Supports count.',
                ],
                'selectHosts' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a hosts property with an array of hosts that the item prototype belongs to.',
                ],
                'selectTags' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return the item prototype tags in tags property.',
                ],
                'selectTriggers' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a triggers property with trigger prototypes that the item prototype is used in. Supports count.',
                ],
                'selectPreprocessing' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a preprocessing property with item prototype preprocessing options.',
                ],
                'selectValueMap' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a valuemap property with item prototype value map.',
                ],
                'filter' => [
                    'type' => 'object',
                ...
                'sortfield' => [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: itemid, name, key_, delay, type, status, history, trends, discovered.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
