...
final class TokenGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for token.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/token/token.get',
            'title' => 'token.get',
            'description' => 'Retrieve tokens according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/token/get',
            'type' => 'object',
            'properties' => [
                'tokenids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only tokens with the given IDs.',
                ],
                'userids' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return only tokens created for the given users.',
                ],
                'token' => [
                    'type' => 'string',
                    'description' => 'Return only tokens created for the given Auth token.',
                ],
                'valid_at' => [
                    'type' => 'integer',
                    'description' => 'Return only tokens, which are valid (not expired) at the given date and time.',
                ],
                'expired_at' => [
                    'type' => 'integer',
                    'description' => 'Return only tokens, which are expired (not valid) at the given date and time.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: tokenid, name, lastaccess, status, expires_at, created_at.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
