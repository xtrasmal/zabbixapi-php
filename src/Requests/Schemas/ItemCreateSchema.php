...
final class ItemCreateSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for item.create, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/item/item.create',
            'title' => 'item.create',
            'description' => 'Create new items. Web items cannot be created via the Zabbix API.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/item/create',
            'type' => 'object',
            'properties' => [
                'delay' => [
                    'type' => 'string',
...
- required if error_handler is set to "Set custom value" or "Set custom error message"',
                    ...
                    'description' => 'Item preprocessing options.',
                ],
                'tags' => [
                    'type' => 'array',
                    'items' => [
