...
final class RoleGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for role.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/role/role.get',
            'title' => 'role.get',
            'description' => 'Retrieve user roles according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/role/get',
            'type' => 'object',
            'properties' => [
                'roleids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only roles with the given IDs.',
                ],
                'selectRules' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a rules property with the role rules.',
                ],
                'selectUsers' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a users property with the users that the role is assigned to. See user.get for restrictions based on user type.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: roleid, name.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
