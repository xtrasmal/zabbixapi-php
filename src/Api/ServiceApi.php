...
final class ServiceApi extends AbstractApi
{
    ...
    public function create(ServiceCreateRequest|array $request): ZabbixRequest
    {
        return $this->request(ServiceCreateRequest::class, $request);
    }

    /** @param list<mixed> $request */
    public function delete(ServiceDeleteRequest|array $request): ZabbixRequest
    {
        return $this->request(ServiceDeleteRequest::class, $request);
    }

    /** @param array<string, mixed> $request */
    public function get(ServiceGetRequest|array $request = []): ZabbixRequest
    {
    ...
    /** @param array<string, mixed> $request */
    public function update(ServiceUpdateRequest|array $request): ZabbixRequest
    {
