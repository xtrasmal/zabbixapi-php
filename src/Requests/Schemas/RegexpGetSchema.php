...
final class RegexpGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for regexp.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/regexp/regexp.get',
            'title' => 'regexp.get',
            'description' => 'Retrieve global regular expressions according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/regexp/get',
            'type' => 'object',
            'properties' => [
                'regexpids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only regular expressions with the given IDs.',
                ],
                'selectExpressions' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return an expressions property. See the Expressions object (reference/regexp/object#expressions).',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: regexpid, name.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
