...
final class ProxygroupGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for proxygroup.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/proxygroup/proxygroup.get',
            'title' => 'proxygroup.get',
            'description' => 'Retrieve proxy groups according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/proxygroup/get',
            'type' => 'object',
            'properties' => [
                'proxy_groupids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only proxy groups with the given IDs.',
                ],
                'proxyids' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return only proxy groups that contain the given proxies.',
                ],
                'selectProxies' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a `proxies` property with the proxies that belong to the proxy group. Supports `count`.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: proxy_groupid, name.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
