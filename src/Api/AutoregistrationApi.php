...
final class AutoregistrationApi extends AbstractApi
{
    ...
    public function get(AutoregistrationGetRequest|array $request = []): ZabbixRequest
    {
        return $this->request(AutoregistrationGetRequest::class, $request);
    }

    /** @param array<string, mixed> $request */
    public function update(AutoregistrationUpdateRequest|array $request): ZabbixRequest
    {
