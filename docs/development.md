...
The bundled Zabbix 7.0 schemas under `schemas/7.0` are JSON source files. Runtime validation reads those files through `JSONSchemaProvider`; there are no generated PHP schema classes.
