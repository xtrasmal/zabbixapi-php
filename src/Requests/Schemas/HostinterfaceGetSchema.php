...
final class HostinterfaceGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for hostinterface.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/hostinterface/hostinterface.get',
            'title' => 'hostinterface.get',
            'description' => 'Retrieve host interfaces according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/hostinterface/get',
            'type' => 'object',
            'properties' => [
                'hostids' => [
                    'oneOf' => [
                ...
                'interfaceids' => [
                    ...
                    'description' => 'Return only host interfaces with the given IDs.',
                ],
                'itemids' => [
                    'oneOf' => [
                        [
                ...
                'selectItems' => [
                    ...
                    'description' => 'Return an items property with the items that use the interface. Supports count.',
                ],
                'selectHosts' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a hosts property with an array of hosts that use the interface.',
                ],
                'limitSelects' => [
                    'type' => 'integer',
                    'description' => 'Limits the number of records returned by subselects. Applies to the following subselects: selectItems.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: interfaceid, dns, ip.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
