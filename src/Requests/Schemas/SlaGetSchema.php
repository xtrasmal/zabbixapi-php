...
final class SlaGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for sla.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/sla/sla.get',
            'title' => 'sla.get',
            'description' => 'Retrieve SLA objects according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/sla/get',
            'type' => 'object',
            'properties' => [
                'slaids' => [
                    'oneOf' => [
                ...
                'selectSchedule' => [
                    ...
                    'description' => 'Return a schedule property with SLA schedules. Supports count.',
                ],
                'selectExcludedDowntimes' => [
                    ...
                    'description' => 'Return an excluded_downtimes property with SLA excluded downtimes. Supports count.',
                ],
                'selectServiceTags' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return a service_tags property with SLA service tags. Supports count.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
                ...
                'sortfield' => [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: slaid, name, period, slo, effective_date, timezone, status, description.',
                ],
                'sortorder' => [
                    'oneOf' => [
                        [
