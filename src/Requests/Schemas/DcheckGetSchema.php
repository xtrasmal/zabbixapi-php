...
final class DcheckGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for dcheck.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/dcheck/dcheck.get',
            'title' => 'dcheck.get',
            'description' => 'Retrieve discovery checks according to the given parameters.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/dcheck/get',
            'type' => 'object',
            'properties' => [
                'dcheckids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only discovery checks with the given IDs.',
                ],
                'druleids' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return only discovery checks that belong to the given discovery rules.',
                ],
                'dserviceids' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return only discovery checks that have detected the given discovered services.',
                ],
                'selectDRules' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Return discovery rules related to the discovery checks.',
                ],
                'sortfield' => [
                    'oneOf' => [
                        [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: dcheckid, druleid.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
