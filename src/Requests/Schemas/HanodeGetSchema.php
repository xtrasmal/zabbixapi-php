...
final class HanodeGetSchema extends RequestSchema
{
    /**
     * Draft 2020-12 schema for hanode.get, compiled from the source JSON at
    ...
    public function definition(): array
    {
        return [
            ...
            '$id' => 'https://zabbix.com/7.0/api/hanode/hanode.get',
            'title' => 'hanode.get',
            'description' => 'Retrieve a list of High availability cluster nodes according to the given parameters. Only available to Super admin user types.',
            '$comment' => 'Source: https://www.zabbix.com/documentation/7.0/en/manual/api/reference/hanode/get',
            'type' => 'object',
            'properties' => [
                'ha_nodeids' => [
                    'oneOf' => [
                    ...
                    'description' => 'Return only nodes with the given node IDs.',
                ],
                'filter' => [
                    'type' => 'object',
                    'description' => 'Return only those results that exactly match the given filter. Accepts an object, where the keys are property names, and the values are either a single value or an array of values to match against. Supports properties: name, address, status.',
                    'properties' => [
                        'name' => [
                            'oneOf' => [
                                [
                ...
                'sortfield' => [
                    ...
                    'description' => 'Sort the result by the given properties. Possible values: name, lastaccess, status.',
                ],
                'countOutput' => [
                    'type' => 'boolean',
